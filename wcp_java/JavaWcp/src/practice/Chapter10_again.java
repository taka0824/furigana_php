...
public class Chapter10_again {
    public static void main(String[] args) {
        ...
        try {
        	...
        	try {
        		Chapter10_again.throwSQLException();
        	} catch(SQLException e) {
        		System.out.print("SQLExceptionが発生しました");
        		e.printStackTrace();
        	}
        // try-catch文を記述
    ...
    public static void validIndex(int[] array, int index) {
    	...
    	System.out.println("インデックス番号" + index + "の要素は" + array[index] + "です。");
    }
    // validIndexメソッドを作成
