...
public class Chapter10 {
    public static void main(String[] args) {
        ...
        try {
            ...
            e.printStackTrace();
//            throw e;
//            上記のようにすると、新たな例外が発生しここで処理が終わってしまう。
//            tryの中で発生した例外はcatchで処理をお行うことができる
        }
    ...
    public static void validIndex(int[] array, int number) {
    	if( number >= array.length) {
    		throw new IllegalArgumentException(number + "はサイズの範囲外です");
    	}
    	System.out.println("index" + number + "の要素は" + array[number] + "です。" );
    }
